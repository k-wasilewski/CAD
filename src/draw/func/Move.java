...
public class Move {
    ...
    public void moveMousewheel() {
        ...
        boolean dif = (x2s != canvas.getX2sh() || y2s != canvas.getY2sh()); //if canvas moved
    ...
    public void move() {
        Point2D pam = new Point2D.Double(MouseInfo.getPointerInfo().getLocation().x - 8 - canvas.getScreenx(),
                MouseInfo.getPointerInfo().getLocation().y - 54 - canvas.getScreeny());
        Point2D pbm = new Point2D.Double();
        canvas.getAtinverted().transform(pam, pbm);
        int x2m = (int) pbm.getX();
        int y2m = (int) pbm.getY();
        boolean dif = x2m != canvas.getX2mh() || y2m != canvas.getY2mh();   //if object was moved
    ...
    public void copy() {
        ...
        boolean dif = x2c != canvas.getX2ch() || y2c != canvas.getY2ch();   //if copied object was moved
